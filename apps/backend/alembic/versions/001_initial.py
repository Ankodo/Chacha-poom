...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", postgresql.ENUM("superadmin", "admin", name="adminrole", create_type=False), server_default="admin"),
    ...
    op.create_table(
        ...
        sa.Column("flag", sa.String(10), server_default="''"),
        sa.Column("cores_config", sa.JSON(), server_default="'{}'"),
        sa.Column("max_users", sa.Integer(), server_default="0"),
        sa.Column("traffic_limit", sa.Integer(), server_default="0"),
        sa.Column("sni_domains", sa.JSON(), server_default="'[]'"),
        sa.Column("cdn_domain", sa.String(255), server_default="''"),
        sa.Column("certificate_type", sa.String(20), server_default="'reality'"),
        sa.Column("status", postgresql.ENUM("online", "offline", "degraded", "maintenance", name="nodestatus", create_type=False), server_default="offline"),
        sa.Column("last_heartbeat", sa.DateTime(timezone=True), nullable=True),
        sa.Column("region_profile", postgresql.ENUM("moscow", "russia-regions", "china", "iran", "universal", name="regionprofile", create_type=False), server_default="universal"),
    ...
    op.create_table(
        ...
        sa.Column("transport_config", sa.JSON(), server_default="'{}'"),
        sa.Column("port", sa.Integer(), nullable=False),
        sa.Column("connection_mode", postgresql.ENUM("direct", "cdn", "domain-fronting", name="connectionmode", create_type=False), server_default="direct"),
        sa.Column("tag", sa.String(100), nullable=False),
        sa.Column("max_connections", sa.Integer(), server_default="0"),
        sa.Column("sniffing", sa.Boolean(), server_default="true"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("active", "expired", "disabled", "limited", name="substatus", create_type=False), server_default="active"),
        ...
        sa.Column("traffic_limit", sa.BigInteger(), server_default="0"),
        sa.Column("traffic_used", sa.BigInteger(), server_default="0"),
        sa.Column("device_limit", sa.Integer(), server_default="0"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending", "completed", "failed", "refunded", name="paymentstatus", create_type=False), server_default="pending"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()")),
        sa.PrimaryKeyConstraint("id"),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["plan_id"], ["plans.id"], ondelete="SET NULL"),
    ...
    op.create_table(
        ...
        sa.Column("node_id", sa.Uuid(), nullable=False),
        sa.Column("timestamp", sa.DateTime(timezone=True), server_default=sa.text("now()")),
        sa.Column("cpu", sa.Float(), server_default="0.0"),
        sa.Column("ram", sa.Float(), server_default="0.0"),
        sa.Column("bandwidth_up", sa.BigInteger(), server_default="0"),
        sa.Column("bandwidth_down", sa.BigInteger(), server_default="0"),
        sa.Column("connections", sa.Integer(), server_default="0"),
        sa.PrimaryKeyConstraint("id"),
        sa.ForeignKeyConstraint(["node_id"], ["nodes.id"], ondelete="CASCADE"),
    )
